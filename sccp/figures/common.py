...
def plotFactorsRelaxed(factors, data: Pf2X, axs, reorder=tuple(), trim=tuple(), saveGenes=False, cond_group_labels= None):
    """Plots parafac2 factors with a relaxed max weight."""
