...
from .commonFuncs.plotUMAP import plotCmpPerCellType, plotLabelsUMAP, plotLabelsUMAP2
...
def makeFigure():
    ...
    cmp1 = 1
    cmp2 = 30 
    plotLabelsUMAP2(X, labelType="Condition",  ax=ax[1], condition=glucs, conditionName="Gluco", cmp1=cmp1, cmp2=cmp2)
