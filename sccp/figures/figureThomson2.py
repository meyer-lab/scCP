...
def makeFigure():
    ...
    X_genes = X_genes[X_genes.obs["Cell Type2"] == "cDCs", :]
    gene_plot_cells(
        X_genes, unique=["Alprostadil"], hue="Condition", ax=ax[8], cellType="Cell Type2", kde=False
    )
    ax[8].set(title="Gene Expression in cDCs")
    ...
    plot_avegene_per_category(["Alprostadil"], "Alpro", "THBS1", X, ax[10], cellType="Cell Type")
    plot_avegene_per_category(
        ["Alprostadil"], "Alpro", "EREG", X, ax[11], cellType="Cell Type"
    )
